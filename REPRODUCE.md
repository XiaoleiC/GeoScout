...
The repository does not commit these artifacts.  Keep full rollout dumps,
preprocessed grids, checkpoints, and numeric summaries in an external artifact
directory.
...
python -m scripts.train \
  ...
  --wandb_project "${WANDB_PROJECT:-geoscout}" \
