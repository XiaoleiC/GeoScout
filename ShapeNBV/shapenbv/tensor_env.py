"""TensorBatchEnv — IsaacGym-style fully tensor-batched VecEnv for ShapeNBV.
...
class TensorBatchEnv(VecEnv):
    """N parallel ShapeNBV envs as one tensor batch.
    ...
    Args:
        ...
        preproc_path: `.pt` from `shapenbv.preprocess.preprocess_mesh`.
        device: "cuda" or "cpu".
    ...
    def __init__(
        ...
        # Action / observation spaces. ShapeNBV uses the normalized Cube
    ...
    def _update_free_voxels(
        ...
        ShapeNBV applies the hit assignment before this free update, so
