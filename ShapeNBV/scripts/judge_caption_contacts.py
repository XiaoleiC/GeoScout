#!/usr/bin/env python3
"""Review and apply manual geometry-caption judgements for ShapeNBV captions.
...
def make_review_atlas(args: argparse.Namespace) -> None:
    ...
    index_lines = [
        ...
        "<title>ShapeNBV Caption Judgement Atlas</title>",
        ...
        f"<h1>ShapeNBV Caption Judgement Atlas</h1><p>{len(rows)} samples, {batch_size} per page.</p>",
    ]
    ...
    progress = {
        "schema_version": "shapenbv_caption_judgement_progress_v1",
...
def snapshot_originals(args: argparse.Namespace) -> None:
    ...
    manifest = {
        "schema_version": "shapenbv_caption_before_manual_judgement_snapshot_v1",
        "created_at_utc": datetime.now(timezone.utc).isoformat(),
        "source_jsonl": str(args.jsonl),
...
def apply_judgements(args: argparse.Namespace) -> None:
    ...
    for row in rows:
        ...
        if judgement:
            ...
            row["manual_caption_judgement"] = {
                "schema_version": "shapenbv_caption_manual_judgement_v1",
                "reviewed_at_utc": now,
    ...
    with args.changed_csv.open("w", newline="", encoding="utf-8") as f:
        ...
        writer.writerows(csv_rows)
    summary = {
        "schema_version": "shapenbv_caption_judgement_apply_summary_v1",
        "source_jsonl": str(args.jsonl),
...
<head>
  <meta charset="utf-8">
  <title>ShapeNBV Caption Judgement Review</title>
  <style>
...
<body>
<header>
  <h1>ShapeNBV Caption Judgement Review</h1>
  <div class="summary">
...
"""
    ...
    summary = {
        "schema_version": "shapenbv_caption_judgement_html_summary_v1",
