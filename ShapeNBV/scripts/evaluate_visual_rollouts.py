"""Full-sample visual rollout evaluator for ShapeNBV.
...
from shapenbv.viz import _y_up_to_z_up
...
<title>ShapeNBV full 600 visual evaluation</title>
<style>
...
<body>
<h1>ShapeNBV full 600 visual evaluation</h1>
...
def main() -> None:
    ...
    p.add_argument("--caption_jsonl", default="/data/shapenbv_captions/full_attr_600_qwen25_7b_a100_batch64_tok256_array_v2_20260506_corrected.jsonl")
    p.add_argument("--contact_sheet_dir", default="")
    p.add_argument("--out_dir", required=True)
    p.add_argument("--discrete_ckpt", default="/runs/train600-24m-discrete-s1-l40s-n128-wandb-0506/ppo_shapenbv.zip")
    p.add_argument("--continuous_ckpt", default="/runs/train600-24m-continuous-s1-l40s-n128-wandb-0506/ppo_shapenbv.zip")
