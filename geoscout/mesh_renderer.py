...
def _points_inside_mesh_ray_parity(
    ...
    *,
    ...
    For non-watertight meshes no parity method can be perfect. GeoScout
...
class NvdiffrastMeshSequenceRenderer(MeshSequenceRenderer):
    ...
    def render_batch(
        ...
        # Pixel-centre convention: GeoScout's ray grid uses integer pixels
        ...
        # GeoScout's cached pixel rays (`ray_y = (row - cy) / f`, positive
