"""Custom CUDA Bresenham scatter for GeoScout free-space updates.

This is a small torch CUDA extension with the same public shape as the
Triton implementation in :mod:`geoscout.triton_bresenham`.  It follows
...
_EXTENSION_NAME = "geoscout_cuda_bresenham_v4"
_EXTENSION = None
    ...
    with _LOAD_LOCK:
        ...
        try:
            ...
            if not _WARNED_LOAD_ERROR:
                warnings.warn(
                    "GeoScout custom CUDA Bresenham extension unavailable; "
