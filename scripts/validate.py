"""Deterministic-rollout viz dumper for GeoScout.
...
from geoscout.env import GeoScoutEnv
from geoscout.mesh_renderer import ShapeNetIndex
from geoscout.viz import save_pointcloud_ply, save_trajectory_plot, save_coverage_curve
...
def main():
    ...
    p.add_argument("--dataset", type=str, default="shapenet",
                   ...
                   help="Source dataset enumerator. Pass `abo` when "
                        ...
                        "geoscout.abo.list_abo + Amazon model_id "
                        "directory layout).")
