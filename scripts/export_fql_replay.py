"""Export GeoScout rollouts as an offline-RL replay buffer.
...
def export_replay(args: argparse.Namespace) -> None:
    ...
    metadata = {
        "format_version": "geoscout_fql_replay_v1",
...
def main() -> None:
    ...
    p.add_argument("--ckpt", default="/runs/train600-24m-discrete-s1-judged-l40s-n128-wandb-0508/ppo_geoscout.zip")
    ...
    p.add_argument("--preproc_dir", default="/data/geoscout_preproc_g128_attr_v2_judged_v1")
